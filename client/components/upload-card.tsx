...
import {CheckCircle, ChevronDown, ChevronUp, FileUp, Loader2, Plus, Upload} from "lucide-react"
    ...
    return (
        <Card className={`relative ${isDragging ? "border-indigo-500 border-2" : ""} shadow-md bg-white`}>
            <CardContent className="p-6">
                ...
                {isAnalyzing && (
                    <div
                        className="mb-6 p-6 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg border border-indigo-200">
